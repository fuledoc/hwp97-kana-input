...
| 날짜 | 책(서가-번호) | 찾은 곳 | 결과 |
|---|---|---|---|
| 2026-09-15 | 積木くずし(7616-8, ISBN 없음) | メルカリ `m58476529700` | 桐原書店 1983년 80쇄 판매 사진(판매글에 235쪽·980엔, 책등 모양이 서가 사진과 같음) → 표지로 씀 |
| 2026-09-15 | 名曲二〇三選(7617-3, ISBN 없음) | メルカリ 「名曲二〇三選」「名曲203選」「立体批評による名盤事典」「ステレオ芸術 名曲」 | 판매글 없음(名曲三〇〇選 등 다른 책만 나옴) |
| 2026-09-15 | 特別史蹟名古屋城(7617-6, ISBN 없음) | 日本の古本屋 `510790084` | 1993년 5판 판매 사진 → 표지로 씀(판 확인 필요 유지) |
| 2026-09-15 | リストラで勝つ! 외 6권 | BOOKOFF | JAN·출판사 일치 → 표지로 씀 |
